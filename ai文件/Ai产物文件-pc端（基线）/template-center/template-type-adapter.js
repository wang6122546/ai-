(function () {
  ...
  const requestedPage = new URLSearchParams(location.search).get('page') || 'center';
  if (requestedPage === 'controls') renderConfiguredControlLibrary();
  else if (requestedPage === 'drafts' || requestedPage === 'versions') simpleList(requestedPage);
  else centerView();
})();
